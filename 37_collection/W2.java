...
public class W2 {
    public static void main(String[] args){
        ...
        list.add(1, 12);//UnsupportedOperationException -> an unchecked exception that comes when we try to add element in the List object that is returned by the asList() method since the returned list is a back list means it cannot grow and shrink but we can perform non-changble operations like get(), size(), isEmpty()
