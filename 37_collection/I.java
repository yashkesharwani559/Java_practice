...
public class I {
    public static void main(String[] args) {
        ...
        SortedMap s = map.tailMap(new Student("om", 21));
        //headMap(K toKey) -> is a method in TreeMap class that returns a SortedMap of elements that are less than or equals to the toKey
