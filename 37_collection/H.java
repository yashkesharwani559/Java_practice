...
public class H {
    public static void main(String[] args) {
        ...
        SortedMap s = map.headMap(new Student("om", 21));
        //headMap(K toKey) -> is a method in TreeMap class that returns a SortedMap of elements that are strictly less than the toKey
