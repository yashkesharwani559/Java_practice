...
public class J {
    public static void main(String[] args) {
        ...
        Student s = map.ceilingKey(new Student("om", 23));
        //ceilingKey(K toKey) -> is a method in TreeMap class that returns a K type key that is the smallest key among the keys that are greater than or equals to the toKey or returns null if there is no such key
